                    ...
                    <div className="col-6">
                        ...
                        <table className="table">
                            ...
                            <tr>
                                ...
                                <td className="info-text">
                                    {formatShortDateTimeFromMillis(query.queryStats.createTimeInMillis)}
                                </td>
                            </tr>
                            <tr>
                                <td className="info-title">
                                ...
                                <td className="info-text">
                                    {query.queryStats.endTimeInMillis ? formatShortDateTimeFromMillis(query.queryStats.endTimeInMillis) : ""}
                                </td>
                            </tr>
                            <tr>
                                <td className="info-title">
