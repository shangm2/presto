...
public class TaskResourceUtils
{
    ...
    private static DriverStats convertToThriftDriverStats(DriverStats driverStats)
    {
        return new DriverStats(
                ...
                driverStats.getQueuedTimeInNanos(),
                driverStats.getElapsedTimeInNanos(),
                ...
                driverStats.getTotalScheduledTimeInNanos(),
                driverStats.getTotalCpuTimeInNanos(),
                driverStats.getTotalBlockedTimeInNanos(),
                ...
                driverStats.getRawInputReadTimeInNanos(),
    ...
    private static OperatorStats convertToThriftOperatorStats(OperatorStats operatorStats)
    {
        return new OperatorStats(
                ...
                operatorStats.getIsBlockedWallInNanos(),
                operatorStats.getIsBlockedCpuInNanos(),
                operatorStats.getIsBlockedAllocationInBytes(),
                operatorStats.getAddInputCalls(),
                operatorStats.getAddInputWallInNanos(),
                operatorStats.getAddInputCpuInNanos(),
                ...
                operatorStats.getGetOutputWallInNanos(),
                operatorStats.getGetOutputCpuInNanos(),
                ...
                operatorStats.getAdditionalCpuInNanos(),
                operatorStats.getBlockedWallInNanos(),
                operatorStats.getFinishCalls(),
                operatorStats.getFinishWallInNanos(),
                operatorStats.getFinishCpuInNanos(),
    ...
    private static DriverStats convertFromThriftDriverStats(DriverStats thriftDriverStats)
    {
        return new DriverStats(
                ...
                thriftDriverStats.getQueuedTimeInNanos(),
                thriftDriverStats.getElapsedTimeInNanos(),
                ...
                thriftDriverStats.getTotalScheduledTimeInNanos(),
                thriftDriverStats.getTotalCpuTimeInNanos(),
                thriftDriverStats.getTotalBlockedTimeInNanos(),
                ...
                thriftDriverStats.getRawInputReadTimeInNanos(),
    ...
    private static OperatorStats convertFromThriftOperatorStats(OperatorStats thriftOperatorStats)
    {
        return new OperatorStats(
                ...
                thriftOperatorStats.getIsBlockedWallInNanos(),
                thriftOperatorStats.getIsBlockedCpuInNanos(),
                thriftOperatorStats.getIsBlockedAllocationInBytes(),
                thriftOperatorStats.getAddInputCalls(),
                thriftOperatorStats.getAddInputWallInNanos(),
                thriftOperatorStats.getAddInputCpuInNanos(),
                ...
                thriftOperatorStats.getGetOutputWallInNanos(),
                thriftOperatorStats.getGetOutputCpuInNanos(),
                ...
                thriftOperatorStats.getAdditionalCpuInNanos(),
                thriftOperatorStats.getBlockedWallInNanos(),
                thriftOperatorStats.getFinishCalls(),
                thriftOperatorStats.getFinishWallInNanos(),
                thriftOperatorStats.getFinishCpuInNanos(),
