        ...
        implements Mergeable<PlanNodeStats>
{
            ...
            Optional<DynamicFilterStats> dynamicFilterStats)
    {
        ...
        this.planNodeScheduledTimeInNanos = checkDurationInNano(planNodeScheduledTimeInNanos, "planNodeScheduledTimeInNanos is negative");
        this.planNodeCpuTimeInNanos = checkDurationInNano(planNodeCpuTimeInNanos, "planNodeCpuTimeInNanos is negative");
        this.planNodeBlockedWallTimeInNanos = checkDurationInNano(planNodeBlockedWallTimeInNanos, "planNodeBlockedWallTimeInNanos is negative");
        this.planNodeAddInputWallTimeInNanos = checkDurationInNano(planNodeAddInputWallTimeInNanos, "planNodeAddInputWallTimeInNanos is negative");
        this.planNodeGetOutputWallTimeInNanos = checkDurationInNano(planNodeGetOutputWallTimeInNanos, "planNodeGetOutputWallTimeInNanos is negative");
        this.planNodeFinishWallTimeInNanos = checkDurationInNano(planNodeFinishWallTimeInNanos, "planNodeFinishWallTimeInNanos is negative");
