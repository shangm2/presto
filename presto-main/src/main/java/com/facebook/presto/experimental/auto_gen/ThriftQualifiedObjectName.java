...
public class ThriftQualifiedObjectName
        implements org.apache.thrift.TBase<ThriftQualifiedObjectName, ThriftQualifiedObjectName._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftQualifiedObjectName>
{
    ...
    public @org.apache.thrift.annotation.Nullable String schemaName; // required
    public @org.apache.thrift.annotation.Nullable String objectName; // required
    ...
    public ThriftQualifiedObjectName setCatalogName(@org.apache.thrift.annotation.Nullable String catalogName)
    {
        this.catalogName = catalogName;
        return this;
    }
    ...
    public ThriftQualifiedObjectName setSchemaName(@org.apache.thrift.annotation.Nullable String schemaName)
    {
        this.schemaName = schemaName;
        return this;
    }
    ...
    public ThriftQualifiedObjectName setObjectName(@org.apache.thrift.annotation.Nullable String objectName)
    {
        this.objectName = objectName;
        return this;
    }
    ...
    public int compareTo(ThriftQualifiedObjectName other)
    {
        ...
        lastComparison = Boolean.compare(isSetCatalogName(), other.isSetCatalogName());
        if (lastComparison != 0) {
        ...
        lastComparison = Boolean.compare(isSetSchemaName(), other.isSetSchemaName());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetSchemaName()) {
        ...
        lastComparison = Boolean.compare(isSetObjectName(), other.isSetObjectName());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetObjectName()) {
    ...
    {
        StringBuilder sb = new StringBuilder("ThriftQualifiedObjectName(");
        boolean first = true;
    ...
    private static class ThriftQualifiedObjectNameStandardSchemeFactory
    ...
    private static class ThriftQualifiedObjectNameStandardScheme
            extends org.apache.thrift.scheme.StandardScheme<ThriftQualifiedObjectName>
    {

        @Override
        public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftQualifiedObjectName struct)
                throws org.apache.thrift.TException
        {
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftQualifiedObjectName struct)
                throws org.apache.thrift.TException
        {
            struct.validate();
    ...
    private static class ThriftQualifiedObjectNameTupleSchemeFactory
            implements org.apache.thrift.scheme.SchemeFactory
    {
        @Override
    ...
    private static class ThriftQualifiedObjectNameTupleScheme
            extends org.apache.thrift.scheme.TupleScheme<ThriftQualifiedObjectName>
    {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, ThriftQualifiedObjectName struct)
                throws org.apache.thrift.TException
        {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, ThriftQualifiedObjectName struct)
                throws org.apache.thrift.TException
        {
