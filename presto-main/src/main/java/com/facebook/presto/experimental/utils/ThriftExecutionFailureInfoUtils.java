...
import static com.facebook.presto.experimental.utils.ThriftErrorCauseUtils.fromErrorCause;
import static com.facebook.presto.experimental.utils.ThriftErrorCauseUtils.toErrorCause;
import static com.facebook.presto.experimental.utils.ThriftErrorCodeUtils.fromErrorCode;
import static com.facebook.presto.experimental.utils.ThriftErrorCodeUtils.toErrorCode;
import static com.facebook.presto.experimental.utils.ThriftErrorLocationUtils.fromErrorLocation;
import static com.facebook.presto.experimental.utils.ThriftErrorLocationUtils.toErrorLocation;
import static com.facebook.presto.experimental.utils.ThriftHostAddressUtils.fromHostAddress;
import static com.facebook.presto.experimental.utils.ThriftHostAddressUtils.toHostAddress;
...
public class ThriftExecutionFailureInfoUtils
{
    ...
    public static ThriftExecutionFailureInfo fromExecutionFailureInfo(ExecutionFailureInfo executionFailureInfo)
    {
        ...
        return new ThriftExecutionFailureInfo(
                ...
                fromExecutionFailureInfo(executionFailureInfo.getCause()),
                suppressed,
