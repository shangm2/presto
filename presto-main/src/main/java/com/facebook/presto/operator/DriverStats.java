...
public class DriverStats
{
            ...
            @JsonProperty("operatorStats") List<OperatorStats> operatorStats)
    {
        ...
        this.queuedTimeInNanos = checkDurationInNano(queuedTimeInNanos, "queuedTime is negative");
        this.elapsedTimeInNanos = checkDurationInNano(elapsedTimeInNanos, "elapsedTime is negative");
        ...
        this.totalScheduledTimeInNanos = checkDurationInNano(totalScheduledTimeInNanos, "totalScheduledTime is negative");
        this.totalCpuTimeInNanos = checkDurationInNano(totalCpuTimeInNanos, "totalCpuTime is negative");
        this.totalBlockedTimeInNanos = checkDurationInNano(totalBlockedTimeInNanos, "totalBlockedTime is negative");
        ...
        this.rawInputReadTimeInNanos = checkDurationInNano(rawInputReadTimeInNanos, "rawInputReadTime is negative");
