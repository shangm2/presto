        ...
        implements OperatorInfo
{
    ...
    public TableFinishInfo(Optional<ConnectorOutputMetadata> metadata, long statisticsWallTimeInNanos, long statisticsCpuTimeInNanos)
    {
        ...
        this.statisticsWallTimeInNanos = checkDurationInNano(statisticsWallTimeInNanos, "statisticsWallTime is negative");
        this.statisticsCpuTimeInNanos = checkDurationInNano(statisticsCpuTimeInNanos, "statisticsCpuTime is negative");
    }
