...
public class QueryStats
{
            ...
            RuntimeStats runtimeStats)
    {
        ...
        this.elapsedTimeInNanos = checkDurationInNano(elapsedTimeInNanos, "elapsedTimeInNanos is negative");
        this.waitingForPrerequisitesTimeInNanos = checkDurationInNano(waitingForPrerequisitesTimeInNanos, "waitingForPrerequisitesTimeInNanos is negative");
        this.queuedTimeInNanos = checkDurationInNano(queuedTimeInNanos, "queuedTimeInNanos is negative");
        this.resourceWaitingTimeInNanos = checkDurationInNano(resourceWaitingTimeInNanos, "resourceWaitingTimeInNanos is negative");
        this.semanticAnalyzingTimeInNanos = checkDurationInNano(semanticAnalyzingTimeInNanos, "semanticAnalyzingTimeInNanos is negative");
        this.columnAccessPermissionCheckingTimeInNanos = checkDurationInNano(columnAccessPermissionCheckingTimeInNanos, "columnAccessPermissionCheckingTimeInNanos is negative");
        this.dispatchingTimeInNanos = checkDurationInNano(dispatchingTimeInNanos, "dispatchingTimeInNanos is negative");
        this.executionTimeInNanos = checkDurationInNano(executionTimeInNanos, "executionTimeInNanos is negative");
        this.analysisTimeInNanos = checkDurationInNano(analysisTimeInNanos, "analysisTimeInNanos is negative");
        this.totalPlanningTimeInNanos = checkDurationInNano(totalPlanningTimeInNanos, "totalPlanningTimeInNanos is negative");
        this.finishingTimeInNanos = checkDurationInNano(finishingTimeInNanos, "finishingTimeInNanos is negative");
        ...
        this.totalScheduledTimeInNanos = checkDurationInNano(totalScheduledTimeInNanos, "totalScheduledTimeInNanos is negative");
        this.totalCpuTimeInNanos = checkDurationInNano(totalCpuTimeInNanos, "totalCpuTimeInNanos is negative");
        this.retriedCpuTimeInNanos = checkDurationInNano(retriedCpuTimeInNanos, "totalCpuTimeInNanos is negative");
        this.totalBlockedTimeInNanos = checkDurationInNano(totalBlockedTimeInNanos, "totalBlockedTimeInNanos is negative");
