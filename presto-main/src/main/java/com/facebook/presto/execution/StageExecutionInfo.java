...
public class StageExecutionInfo
{
    ...
    private static class TaskStatsAggregator
    {
        ...
        private final List<OperatorStats> operatorSummaries = new ArrayList<>();
        ...
        {
            operatorStatsByKey.forEach((key, statsToMerge)
                    -> operatorSummaries.add(statsToMerge.get(0).add(statsToMerge.subList(1, statsToMerge.size()))));
            return ImmutableList.copyOf(operatorSummaries);
        }
