...
public class TestTaskStats
{
    ...
    {
        assertEquals(actual.getCreateTimeInMillis(), new DateTime(1, UTC));
        assertEquals(actual.getFirstStartTimeInMillis(), new DateTime(2, UTC));
        assertEquals(actual.getLastStartTimeInMillis(), new DateTime(100, UTC));
        assertEquals(actual.getLastEndTimeInMillis(), new DateTime(101, UTC));
        assertEquals(actual.getEndTimeInMillis(), new DateTime(3, UTC));
