...
public class TestPipelineStats
{
    ...
    {
        assertEquals(actual.getFirstStartTimeInMillis(), new DateTime(100, UTC));
        assertEquals(actual.getLastStartTimeInMillis(), new DateTime(101, UTC));
        assertEquals(actual.getLastEndTimeInMillis(), new DateTime(102, UTC));
