        ...
        implements ConnectorCodecProvider
{
    ...
    public TpcdsCodecProvider(Provider<ThriftCodecManager> thriftCodecManagerProvider, ByteBufferPool pool)
    {
    ...
    {
        return Optional.of(new TpcdsSplitCodec(thriftCodecManagerProvider, pool));
    }

    @Override
    public Optional<ConnectorCodec<ConnectorTransactionHandle>> getConnectorTransactionHandleCodec()
    {
        return Optional.of(new TpcdsTransactionHandleCodec(thriftCodecManagerProvider, pool));
    }

    @Override
    public Optional<ConnectorCodec<ConnectorTableLayoutHandle>> getConnectorTableLayoutHandleCodec()
    {
        return Optional.of(new TpcdsTableLayoutHandleCodec(thriftCodecManagerProvider, pool));
    }

    @Override
    public Optional<ConnectorCodec<ConnectorTableHandle>> getConnectorTableHandleCodec()
    {
        return Optional.of(new TpcdsTableHandleCodec(thriftCodecManagerProvider, pool));
    }
}
