...
public class ConnectorTransactionHandleThriftCodec
        implements ThriftCodec<ConnectorTransactionHandleWrapper>
{
    ...
    private static final ThriftType THRIFT_TYPE = createConnectorSpecificThriftType(ConnectorTransactionHandleWrapper.class, "transactionHandle", "getTransactionHandle");
    private final ConnectorSpecificCodecManager connectorSpecificCodecManager;
    private final JsonCodec<ConnectorTransactionHandleWrapper> jsonCodec;

    @Inject
    public ConnectorTransactionHandleThriftCodec(JsonCodec<ConnectorTransactionHandleWrapper> jsonCodec, ConnectorSpecificCodecManager connectorSpecificCodecManager, ThriftCatalog thriftCatalog)
    {
    ...
    @Override
    public ConnectorTransactionHandleWrapper read(TProtocolReader protocol)
            throws Exception
    {
        ...
        return new ConnectorTransactionHandleWrapper(connectorId, connectorSpecificCodecManager.getConnectorTransactionHandleCodec(connectorId).deserialize(bytes));
    }

    @Override
    public void write(ConnectorTransactionHandleWrapper value, TProtocolWriter protocol)
            throws Exception
    {
