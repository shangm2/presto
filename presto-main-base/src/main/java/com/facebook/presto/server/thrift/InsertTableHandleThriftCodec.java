        ...
        extends AbstractTypedThriftCodec<ConnectorInsertTableHandle>
{
            ...
            @ForPooledByteBuffer ByteBufferPool pool)
    {
        ...
        System.out.println("=====> InsertTableHandleThriftCodec, id: " + pool.getId());
    }
            ...
            throws Exception
    {
        ...
        return connectorCodecManager.getInsertTableHandleCodec(connectorId)
                .map(codec -> {
                    try {
            ...
            throws Exception
    {
        ...
        connectorCodecManager.getInsertTableHandleCodec(connectorId)
                .ifPresent(codec -> {
                    try {
