        ...
        extends AbstractTypedThriftCodec<ConnectorOutputTableHandle>
{
            ...
            @ForPooledByteBuffer ByteBufferPool pool)
    {
        ...
        System.out.println("=====> OutputTableHandleThriftCodec, id: " + pool.getId());
    }
            ...
            throws Exception
    {
        ...
        return connectorCodecManager.getOutputTableHandleCodec(connectorId)
                .map(codec -> {
                    try {
            ...
            throws Exception
    {
        ...
        connectorCodecManager.getOutputTableHandleCodec(connectorId)
                .ifPresent(codec -> {
                    try {
