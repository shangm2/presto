...
public class ConnectorSplitThriftCodec
        implements ThriftCodec<ConnectorSplitWrapper>
{
    ...
    private static final ThriftType THRIFT_TYPE = createConnectorSpecificThriftType(ConnectorSplitWrapper.class, "connectorSplit", "getConnectorSplit");
    private final ConnectorSpecificCodecManager connectorSpecificCodecManager;
    private JsonCodec<ConnectorSplitWrapper> jsonCodec;

    @Inject
    public ConnectorSplitThriftCodec(JsonCodec<ConnectorSplitWrapper> jsonCodec, ConnectorSpecificCodecManager connectorSpecificCodecManager, ThriftCatalog thriftCatalog)
    {
    ...
    @Override
    public ConnectorSplitWrapper read(TProtocolReader protocol)
            throws Exception
    {
        ...
        return new ConnectorSplitWrapper(connectorId, connectorSpecificCodecManager.getConnectorSplitCodec(connectorId).deserialize(bytes));
    }

    @Override
    public void write(ConnectorSplitWrapper value, TProtocolWriter protocol)
            throws Exception
    {
