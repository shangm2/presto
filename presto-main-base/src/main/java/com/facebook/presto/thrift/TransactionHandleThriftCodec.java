...
{
    @Inject
    public TransactionHandleThriftCodec(HandleResolver handleResolver, Provider<ThriftCodecManager> thriftCodecManagerProvider, JsonCodec<ConnectorTransactionHandle> jsonCodec)
    {
