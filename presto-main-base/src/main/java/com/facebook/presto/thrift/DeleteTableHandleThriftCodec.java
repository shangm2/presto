...
{
    @Inject
    public DeleteTableHandleThriftCodec(HandleResolver handleResolver, Provider<ThriftCodecManager> thriftCodecManagerProvider, JsonCodec<ConnectorDeleteTableHandle> jsonCodec)
    {
