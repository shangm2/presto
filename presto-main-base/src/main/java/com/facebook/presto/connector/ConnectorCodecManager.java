...
public class ConnectorCodecManager
{
    ...
    @Inject
    public ConnectorCodecManager(Provider<ThriftCodecManager> thriftCodecManagerProvider, ByteBufferPoolProvider byteBufferPoolProvider)
    {
        requireNonNull(thriftCodecManagerProvider, "thriftCodecManager is null");

        connectorCodecProviders.put(REMOTE_CONNECTOR_ID.toString(), new RemoteCodecProvider(thriftCodecManagerProvider, byteBufferPoolProvider));
    }
