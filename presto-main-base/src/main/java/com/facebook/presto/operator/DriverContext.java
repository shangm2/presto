...
public class DriverContext
{
    ...
    public DriverStats getDriverStats()
    {
        ...
        long queuedTimeInNanos = nanosBetween(createNanos, executionStartTimeInMillis == 0 ? System.nanoTime() : startNanos.get());

        // endNanos is always valid once executionStartTime is not null
        long executionEndTimeInMillis = this.executionEndTime.get();
        long elapsedTimeInNanos = nanosBetween(createNanos, executionEndTimeInMillis == 0 ? System.nanoTime() : endNanos.get());
        ...
        if (inputOperator != null) {
            ...
            rawInputReadTimeInNanos = inputOperator.getAddInputWallInNanos();
