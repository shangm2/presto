...
public class TestTaskManagerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(TaskManagerConfig.class)
                ...
                .setInfoRefreshMaxWaitInNanos(new Duration(0, SECONDS))
                ...
                .setInfoMaxAgeInNanos(new Duration(15, TimeUnit.MINUTES))
    ...
    public void testExplicitPropertyMappings()
    {
        ...
        TaskManagerConfig expected = new TaskManagerConfig()
                ...
                .setInfoRefreshMaxWaitInNanos(new Duration(3, SECONDS))
                ...
                .setInfoMaxAgeInNanos(new Duration(22, TimeUnit.MINUTES))
