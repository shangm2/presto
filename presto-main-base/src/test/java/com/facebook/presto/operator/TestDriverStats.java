...
public class TestDriverStats
{
    ...
    public static void assertExpectedDriverStats(DriverStats actual)
    {
        ...
        assertEquals(actual.getQueuedTimeInNanos(), 4L);
        assertEquals(actual.getElapsedTimeInNanos(), 5L);
        ...
        assertEquals(actual.getTotalScheduledTimeInNanos(), 9L);
        assertEquals(actual.getTotalCpuTimeInNanos(), 10L);
        assertEquals(actual.getTotalBlockedTimeInNanos(), 12L);
        ...
        assertEquals(actual.getRawInputReadTimeInNanos(), 15L);
