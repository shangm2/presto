...
public final class ResourceEstimates
{
    ...
    public ResourceEstimates(long executionTimeInNanos, long cpuTimeInNanos, long peakMemoryInBytes, long peakTaskMemoryInBytes)
    {
        ...
        this.cpuTimeInNanos = checkNonNegative(cpuTimeInNanos, "cpuTimeInNanos is negative");
        this.peakMemoryInBytes = checkNonNegative(peakMemoryInBytes, "peakMemoryInBytes is negative");
        this.peakTaskMemoryInBytes = checkNonNegative(peakTaskMemoryInBytes, "peakTaskMemoryInBytes is negative");
    }
